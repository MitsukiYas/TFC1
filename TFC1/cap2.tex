...
\begin{figure}[H]
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Imagenes/Leow_Wind_Pwr.jpeg}
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Imagenes/XU_Wind_Topography.png}
	\end{minipage}
	\par\medskip
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.6\textwidth]{Imagenes/GARCIA_Var_Irr.png} \par\medskip
	\raggedright
