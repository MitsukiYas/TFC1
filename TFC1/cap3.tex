...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		Fusible cerámico de cartucho \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/FusibleCeramico.jpg} & 
		Fusible electrónico eFuse \par\smallskip \includegraphics[width=0.9\linewidth]{ImagenesMatriz/eFuse.jpg} & 
		Disyuntor termomagnético \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/DisyuntorTermomagnetico.jpg} \\ \hline
		
		\textbf{3. Gestionar energía eléctrica} & 
		Batería NiMH + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/NiMh.jpg} & 
		Batería LiIon + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/LiIon.jpg} & 
		Batería LiPO + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/LiPo.jpg} \\ \hline
		
		\textbf{4. Activar energía eléctrica} & 
		Seccionador rotativo manual \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/Rotativo.jpg} & 
		Relé de estado sólido \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ReleEstadoSolido.jpg} & 
		Contactor mecánico \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/Contactor.jpg} \\ \hline
		
		\textbf{5. Regular energía de Interfaz} \vspace{0.2cm} & 
		\multirow{3}{=}{\centering Regulador de bomba de carga fija\par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{ImagenesMatriz/PumpChargeRegulador.jpg}} & 
		...
		\multirow{3}{=}{\centering Regulador Shunt \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{ImagenesMatriz/ShuntRegulator.jpg}} \\ \cline{1-1}
		...
		Convertidor Buck DC-DC \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ConvertidorBuck.jpg} & 
		Regulador de bomba de carga \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/PumpChargeRegulador.jpg} & 
		Regulador lineal LDO \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ReguladorLDO.jpg} \\ \hline
		%
		\pagebreak
		...
		\multirow{3}{=}{\centering Conectores circular roscado \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{ImagenesMatriz/ConectorRoscado.jpg}} & 
		\multirow{3}{=}{\centering Barras colectoras Busbars \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{ImagenesMatriz/Busbar.jpg}} \\ \cline{1-1}
		...
		Conector Circular Roscado \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ConectorRoscado.jpg} & 
		Barras colectoras Busbars \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/Busbar.jpg} \\ \hline
		%%
		...
		Regulador Shunt \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ShuntRegulator.jpg} \\ \hline
		%%
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		Termopar tipo K \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/Termopar.jpg} & 
		Sensor RTD PT100 \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/SensorRTD.jpg} \\ \hline
		...
		Sensor 3D de tiempo de vuelo \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/SensorToF.jpg}& 
		Módulo CMOS \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/CMOSModule.jpg} & 
		Sensor LiDAR 3D \par\smallskip \includegraphics[width=0.9\linewidth]{ImagenesMatriz/LIDAR3D.jpg} \\ \hline
		...
		Sensor de distancia por tiempo de vuelo \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/SensorDistanciaToF.jpg} & 
		Unidad IMU de 9 ejes \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/IMU9Ejes.jpg} & 
		Encoder rotativo absoluto \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/EncoderRotativoAbsoluto.jpg} \\ \hline
		...
		Potenciómetro lineal \par\bigskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/PotenciometroLineal.jpg}& 
		Sensor de ultrasonido \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/SensorUltrasonido.jpg} \\ \hline
		
		\textbf{7. Captar señal GPS} & 
		Antena de circuito flexible \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/AntenaFlexible.png} & 
		Antena de parche cerámico \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/AntenaGNSS.jpg} & 
		Antena helicoidal cuadrifilar \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/AntenaCuadrifilar.png} \\ \hline
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		\multirow{3}{=}{\centering Control SMC \par\vspace{0.2cm} \includegraphics[width=\linewidth]{ImagenesMatriz/ControlSMC.png}} & 
		\multirow{3}{=}{\centering Control PID \par\vspace{0.2cm} \includegraphics[width=\linewidth]{ImagenesMatriz/ControlPID.png}} & 
		\multirow{3}{=}{\centering Lógica Difusa \par\vspace{0.2cm} \includegraphics[width=\linewidth]{ImagenesMatriz/LogicaDifusa.png}} \\ \cline{1-1}
		\textbf{10. Controlar movimiento de orientación de plataforma} & & & \\ \cline{1-1}
		\textbf{11. Controlar posicionamiento de plataforma} & & & \\ \hline
		% --- FILAS INDIVIDUALES ---
		\textbf{12. Procesar dirección de traslación} & 
		Controlador Stanley paralelo \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/StanleyParalelo.png} & 
		Algoritmo Pure Pursuit \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/PurePursuit.png} & 
		Algoritmo Vector Pursuit\par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/VectorPursuit.png} \\ \hline
		...
		Flujo óptico \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/OpticalFlow.jpg} & 
		Agrupamiento y segmentación \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/AgrupamientoSegmentacion.png} \\ \hline
		\textbf{14. Registrar datos meteorológicos} & 
		Buffer de almacenamiento asíncrono \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/AsyncMemoria.jpg} & 
		Acceso directo a sistemas de archivos embebidos \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/FAT32.png} & 
		Motores de data bases \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/SQLite.png} \\ \hline
		\textbf{15. Procesar rutas de inspección} \vspace{1.5cm} & 
		\multirow{2}{=}{\centering A - Navigation por mapas de nodos \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/RoadmapNodes.jpg}} & 
		\multirow{2}{=}{\centering B - Navegación por histograma de campo vectorial\par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/VectorFieldNav.png}} & 
		\multirow{2}{=}{\centering C - Navegación por mapas de costo\par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/Costmap.png}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{2}{=}{ Trilaterización con Dead Reckoning \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ModuloGPSDeadReckoning.jpg}} & 
		\multirow{2}{=}{ Medición de fase de onda \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ModuloFasePortadora.jpg}} \\ \cline{1-1}
		\textbf{2. Procesar señal de mando} \vspace{0.8cm} & & & \\ \hline
		% --- FIN BLOQUE 1-2 ---
		% --- INICIO BLOQUE 3-4 ---
		\textbf{3. Transmitir estado de telemetría} \vspace{0.8cm} & 
		\multirow{2}{=}{Protocolo MQTT +Wi-Fi\par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/ProtocoloMQTT.png}} & 
		\multirow{2}{=}{Módulo LoRa \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/ModuloLoRa.jpg}} & 
		\multirow{2}{=}{Celular LTE-M \par\smallskip \includegraphics[width=0.7\linewidth]{ImagenesMatriz/CelularLTEM.jpg}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{2}{=}{Sirena LED \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/SirenaLED.jpg}} \\ \cline{1-1}
		...
		\multirow{2}{=}{LEDs indicadores \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/LEDIndicador.jpeg}} & 
		\multirow{2}{=}{Pantalla LCD \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/PantallaLCD.jpg}} & 
		\multirow{2}{=}{Pantalla HMI \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/PantallaHMI.jpg}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		Microservo digital \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/Miniservo.jpg}& Servomotor Brushless DC \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/ServomotorBrushless.jpg}& 	Motor paso a paso NEMA \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/MotorNEMA.jpg}\\ \hline
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{2}{=}{Piezas de MDF \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/PiezasMDF.jpg}} & 
		\multirow{2}{=}{Perfil V-Slot \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/Vslot.jpg}} & 
		\multirow{2}{=}{Chapas de Acero \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/ChapaAcero.jpg}} \\ \cline{1-1}
		\textbf{2. Soportar componentes} & & & \\ \hline
		
		\pagebreak
		\textbf{3. Proteger componentes} \vspace{1cm}& 
		\multirow{3}{=}{Carcasa impresa en 3D \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/Carcasa3D.jpg}} & 
		...
		\multirow{3}{=}{Caja de acero inoxidable \par\smallskip \includegraphics[width=0.8\linewidth]{ImagenesMatriz/CajaChapaAcero.jpg}} \\ \cline{1-1}
		\textbf{4. Alojar gestionador} & & & \\ \cline{1-1}
		\textbf{5. Alojar memoria externa} & & & \\ \hline
		\textbf{6. Generar movimiento de traslación} & 
		Ruedas onmidireccionales \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/RuedaOnmidireccional.jpg} & 
		Tracción diferencial (4 ruedas) \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/RuedasTraccionDiferencial.png} & 
		Ruedas con tracción de oruga \par\smallskip \includegraphics[width=\linewidth]{ImagenesMatriz/RuedasTraccionOruga.jpg} \\ \hline
