...
\begin{itemize}
    ...
    \item $C_{K}$: Factor de ajuste de potencia nominal por temperatura. Sin unidades. Calculado a través de la ecuación.
\end{itemize}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/IEEE_V_Irr.png}
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/IEEE_T_Pwr.png}
	\end{minipage}
	\par\medskip
...
\subsubsection{\textbf{Albedo:}} En el sector fotovoltaico actual, además de los módulos convencionales monofaciales, se emplean cada vez más los paneles bifaciales, los cuales incorporan celdas activas en ambas caras del módulo y son capaces de captar tanto la radiación solar directa en su cara frontal como la radiación reflejada por el suelo en su cara posterior. En este contexto, el albedo, definido como la fracción de luz solar reflejada por la superficie del terreno, adquiere un rol determinante en el rendimiento de estos módulos: un mayor índice de albedo incrementa significativamente la corriente generada en la cara trasera, lo que se traduce en una mayor ganancia bifacial y maximiza la producción total de energía del sistema \citep{Barreno2024}. En la Figura \ref{fig:CurvasElectricasAlbHum} (izquierda), se puede apreciar que, para todo el rango del coeficiente de albedo, la ganancia bifacial aumenta desde 5 a 25\,\%.
    
\subsubsection{\textbf{Humedad y precipitaciones:}} Los altos niveles de humedad relativa provocan la refracción, reflexión y difracción de la luz solar. Esto atenúa la cantidad de radiación directa que logra alcanzar las celdas fotovoltaicas, reduciendo la corriente generada.   En contraste, aunque las precipitaciones reducen la irradiancia momentáneamente, actúan como un mecanismo de mitigación de suciedad al lavar la superficie del panel, removiendo las partículas acumuladas causantes del \textit{soiling} \citep{Kazem2015Humidity}. En la Figura \ref{fig:CurvasElectricasAlbHum} (derecha), se observa que, para una diferencia de humedad del 30\% (entre 95 y 65 \%), el valor de la potencia aumenta de 50 a 105~W (+110\%),
...
\begin{figure}[H]
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/BARRENO_Alb_Ganancia.jpeg}
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/KAZEM_Hum_Pwr.png}
	\end{minipage}
	\par\medskip
...
\subsubsection{\textbf{Impacto aerodinámico en topografías complejas:}} El viento presenta un efecto dual. Por un lado, cuando la velocidad del viento es moderada, este favorece el enfriamiento convectivo de los paneles, disipando el calor acumulado y reduciendo la temperatura de la celda, lo que incrementa la eficiencia y la potencia eléctrica de salida. 
Por otro lado, las ráfagas actúan como el principal transporte de partículas. Esto eleva las tasas de deposición de suciedad sobre los cristales, disminuyendo la generación de energía \citep{Vick_WindEffect}. En la Figura \ref{fig:VientoMarcoTeorico} (izquierda), se observa una comparación cualitativa de la potencia de salida de dos paneles solares, con una diferencia promedio a lo largo de día de 7~W (11\% de potencia máxima de panel con aire).

A pesar de la importancia crítica de este enfriamiento convectivo, cuando las plantas a gran escala se instalan sobre terrenos montañosos, las laderas alteran drásticamente el flujo de aire homogéneo. Tal como se evidencia en los contornos de velocidad de la Figura \ref{fig:VientoMarcoTeorico} (derecha) del estudio de \cite{Xu2024}, el relieve actúa como una barrera que estanca el viento en la base de la pendiente, anulando el enfriamiento convectivo, y lo acelera en la cresta. Esta dinámica de fluidos provoca que la capacidad de disipación de calor varíe severamente dependiendo de la elevación exacta de cada panel en el terreno, dando origen a la formación de microclimas.

\begin{figure}[H]
	
	\captionsetup{justification=raggedright, singlelinecheck=false, labelsep=none}
	
	\caption[Comparación entre potencia genera en un panel con o sin viento (izquierda) y efecto de la inclinación de una pendiente en el perfil de velocidad en la base de una ladera de 30° (derecha).]{} 
	
	\textit{Comparación entre potencia genera en un panel con o sin viento (izquierda) y efecto de la inclinación de una pendiente en el perfil de velocidad en la base de una ladera de 30° (derecha).} \par\medskip
	
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/Leow_Wind_Pwr.jpeg}
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/Graficas/XU_Wind_Topography.png}
	\end{minipage}
	\par\medskip
	
	\raggedright
	\footnotesize \textit{Nota.} Adaptado de \cite{Leow2019Wind} (izquierda). Adaptado de \cite{Xu2024} (derecha).
	\label{fig:VientoMarcoTeorico}
\end{figure}




\subsubsection{Formación de microclimas y heterogeneidad espacial}
Las variaciones aerodinámicas generan un enfriamiento desigual en la planta. Al recibir distintos flujos de aire, los paneles experimentan gradientes térmicos considerables; tal como lo demuestra empíricamente el histograma de la Figura \ref{fig:Garcias2014Temp} del estudio de \cite{Garcia2014}, se registran variaciones de temperatura de hasta 7 °C entre módulos separados por 466 y 2716 metros. A este desbalance térmico se suma la variabilidad de la radiación reflejada (albedo) producida por las diferentes inclinaciones del suelo \citep{Salinas2025}. En consecuencia, el rendimiento eléctrico no es uniforme, lo que invalida la premisa de un entorno térmico estable y exige el uso de medición climática dinámica en todo el terreno.

\begin{figure}[H]
	\captionsetup{justification=raggedright, singlelinecheck=false, labelsep=none}
	\caption[Frecuencia anual de las diferencias máximas de irradiancia diaria entre módulos fotovoltaicos por dispersión geográfica.]{} 
	\textit{Frecuencia anual de las diferencias máximas de irradiancia diaria entre módulos fotovoltaicos por dispersión geográfica.} \par\medskip
	
	\centering
	\includegraphics[width=0.6\textwidth]{Recursos/Imagenes/Graficas/GARCIA_Var_Irr.png} \par\medskip
	\raggedright
	\footnotesize \textit{Nota.} Gráfico adaptado del artículo ``Solar irradiation and PV module temperature dispersion
	at a large-scale PV plant'' \citep{Garcia2014}.
	\label{fig:Garcias2014Temp}
\end{figure}

\subsubsection{Pérdidas Técnicas:}

La eficiencia de esta conversión disminuye significativamente bajo condiciones operativas reales debido a dos fenómenos físicos principales. En primer lugar, el efecto térmico provoca que las celdas solares pierdan eficiencia a medida que su temperatura aumenta, ya que dicho incremento genera un coeficiente negativo en el voltaje de circuito abierto que reduce drásticamente la potencia máxima de salida \citep{Vieira2024}. Por otro lado, el fenómeno del \textit{soiling} consiste en la acumulación de polvo, arena y contaminantes sobre la superficie de los módulos; esta capa de suciedad interfiere con la transmisión de la luz mediante procesos de absorción, reflexión y dispersión, generando pérdidas eléctricas que, al distribuirse de forma no uniforme, pueden derivar en la formación de puntos calientes” perjudiciales para la vida útil del panel y reducir severamente la rentabilidad de la instalación \citep{TesisJGB}.
...
\textbf{Distribución de sensores} & Muestreo espacial representativo de la irradiancia y temperatura en la planta. & Garantiza que los datos reflejen los microclimas y la topografía real del terreno. & \multicolumn{2}{p{5.6cm}|}{Requiere múltiples sensores distribuidos según la capacidad instalada.} \\ \hline
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.6\textwidth]{Recursos/Imagenes/Otros/PlantaPendiente.png} \par\medskip
...
\subsubsection{\textbf{Estación meteorológica fotovoltaica móvil (CN 216956405 U):}} Esta patente describe, como se ilustra en la Figura \ref{fig:CN216956405U} (izquierda), una estación climática (2) montada sobre una base con ruedas, vista en Figura la \ref{fig:CN216956405U} (derecha), que incluye soportes roscados, compuestos por una funda roscada y una varilla roscada, y placas o almohadillas estabilizadoras (5) que se despliegan hacia abajo para anclar el equipo en superficies desniveladas. El sistema destaca por su enfoque en la estabilización mecánica del equipo de medición, utilizando estos mecanismos de anclaje desplegables que aseguran que los sensores meteorológicos mantengan un plano de referencia adecuado al evitar que la base se incline, así como evita volcaduras el recorrido en terrenos con pendiente.
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.4\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN216956405U-1.png}
		\end{minipage}\hfill
		\begin{minipage}{0.4\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN216956405U-2.png}
		\end{minipage}
		\par\medskip
...
\subsubsection{\textbf{Vehículo de inspección para plantas de energía fotovoltaicas (CN 218409341 U):}} Es un vehículo terrestre no tripulado, mostrado en la Figura \ref{fig:CN218409341U}, montado sobre una base (1), equipado con ruedas de movimiento (21), paneles solares abatibles (12) para carga y un robusto mecanismo de amortiguación mediante resortes (20) en cajas para evitar daños en la instrumentación durante el tránsito. Esta patente representa una solución integral para la problemática, implementando el uso de paneles solares integrados para la recarga autónoma y sistemas de amortiguación para la protección de la instrumentación, lo que asegura la precisión de las mediciones dinámicas y prolonga la autonomía.
	...
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=0.75\textwidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN218409341U.png} \par\medskip
...
Este robot, como se ilustra en la Figura \ref{fig:CN221163061U}, cuenta con tracción de orugas (2) diseñada con ángulos de inclinación anti-deslizamiento (22) y está equipado con radar y sensores de viento, humedad y radiación o luz. La propuesta se alinea con el propósito general del proyecto, ya que el diseño integrado de un tren de tracción para terrenos desérticos acoplado a un sistema completo de sensores climáticos sirve como el principal punto de referencia comercial y tecnológico para validar la arquitectura y el alcance funcional del UGV de irradiancia propuesto.
	...
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=0.7\textwidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN221163061U.png} \par\medskip
...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.6\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN119665962A.png}
		\end{minipage}\hfill
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN120057153A.png}
		\end{minipage}
		\par\medskip
	...
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=0.4\textwidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN220873036U.png} \par\medskip
...
\begin{itemize}
	...
	\item \textbf{Robot de inspección para plantas de energía con mecanismo de corte (CN 215701759 U):} Este vehículo, como se ilustra en la Figura \ref{fig:CN215511023U&CN215701759U} (derecha) está equipado con un brazo giratorio (7) que posee un motor (8) y aspas de corte integradas (9). Este mecanismo permite al robot abrirse paso a través de vegetación o maleza que pueda obstruir las rutas de inspección, garantizando la continuidad del servicio de mantenimiento.
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN215511023U.png}
		\end{minipage}\hfill
		\begin{minipage}{0.6\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN215701759U.png}
		\end{minipage}
		\par\medskip
...
\begin{figure}[H]
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN216243088U.png}
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN206638837U.png}
	\end{minipage}
	\par\medskip
...
\item \textbf{Micro estación meteorológica automática y retractable (CN 222047271 U):} Esta patente describe, como se ilustra en la Figura \ref{fig:CN206362955U&CN222047271U} (derecha), una estación climática (2) montada sobre una base con ruedas (1) que incluye soportes roscados, compuestos por una funda roscada y una varilla roscada, y placas o almohadillas estabilizadoras (5) que se despliegan hacia abajo para anclar el equipo en superficies desniveladas. El sistema destaca por su enfoque en la estabilización mecánica del equipo de medición, utilizando estos mecanismos de anclaje desplegables que aseguran que los sensores meteorológicos mantengan un plano de referencia adecuado al evitar que la base se incline y eviten volcaduras durante la recolección de datos estáticos en terrenos con pendiente. 
...
\begin{figure}[H]
	...
	\begin{minipage}{0.6\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN206362955U.png}
	\end{minipage}\hfill
	\begin{minipage}{0.2\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/CN222047271U-1.png}
	\end{minipage}
	\par\medskip
...
\end{figure}
    ...
    \item \textbf{MeteoPV:} Este producto comercial, visto en la Figura \ref{fig:MeteoPV} (izquierda), es una plataforma de monitorización del recurso solar diseñada específicamente para aplicaciones fotovoltaicas distribuidas. Funciona como un adquisidor de datos compacto con interfaz web integrada que facilita la configuración de piranómetros inteligentes, celdas de referencia y sensores de temperatura posterior, transmitiendo la información mediante protocolos industriales como Modbus RTU y TCP/IP hacia sistemas SCADA.
    	...
    	\centering
    	\includegraphics[width=0.3\textwidth]{Recursos/Imagenes/ImagenesEstadoDelArte/MeteoPV.png} \par\medskip
...
\begin{itemize}
    ...
    \begin{figure}[H]
    	...
    	\begin{minipage}{0.5\textwidth}
    		\centering
    		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/KippZonen_SunTrackers.png}
    	\end{minipage}\hfill
    	\begin{minipage}{0.5\textwidth}
    		\centering
    		\includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesEstadoDelArte/KippZonen_Radiometer.jpg}
    	\end{minipage}
    	\par\medskip
...
%
%
El análisis de las soluciones tecnológicas actuales evidencia una brecha significativa en el sector para resolver el problema de los microclimas en topografías complejas. Por un lado, los vehículos terrestres desarrollados para la industria solar poseen sistemas de locomoción robustos capaces de superar desniveles, pero su instrumentación está limitada a inspecciones visuales o térmicas, lo cual es insuficiente para el mapeo climático dinámico exigido por la norma IEC 61724-1. Por otro lado, las estaciones meteorológicas móviles cuentan con los instrumentos correctos y sistemas de nivelación, pero carecen de la tracción y autonomía necesarias para transitar sobre pendientes extremas. En consecuencia, se justifica la necesidad de desarrollar el sistema mecatrónico propuesto en este proyecto: un robot híbrido que integre la posibilidad de locomoción con la implementación de instrumentación climática, capaz de nivelarse y operar autónomamente sobre los relieves de la instalación.
...
Para estructurar visualmente el nivel de interacción de cada actor con el equipo y sus datos, se emplea un Stakeholder Map basado en un modelo concéntrico (ver Figura \ref{fig:StakeholderMap}). Esta herramienta clasifica a los agentes en tres niveles de proximidad: el núcleo operativo, el entorno comercial y de gestión y la periferia normativa e institucional.
	...
	\centering
	\includegraphics[width=\textwidth]{Recursos/Imagenes/Otros/StakeholderMap.png} \par\medskip
...
\hline
\rowcolor[HTML]{D9E1F2} 
\textbf{ID} & \textbf{Tipo} & \textbf{Característica} & \textbf{Descripción técnica} & \textbf{Justificación} & \textbf{Método de verificación} \\ \hline
\endhead
...
1 & E & Geometría & El vehículo debe tener dimensiones máximas de 600x600x500 mm y una masa total inferior a 20kg, respetando los límites ergonómicos de carga para los operarios. & Restricciones espaciales de los pasillos entre los seguidores solar \citep{ProyectoEjecutivo2024}. & Inspección con cinta métrica y pesaje con balanza industrial calibrada. \\ \hline

2 & E & Posicionamiento & El vehículo debe posicionar la plataforma de medición de irradiancia en una altura de 1300mm desde el suelo & Los piranómetros deben encontrarse en una altura mayor a 1 metro \citep{IEC61724-1_2021} o a una altura que garantice un horizonte despejado \citep{GuiaMercosur2024} & Medición desde el nivel del suelo hasta la base de la plataforma en su estado de máximo despliegue. \\ \hline

3 & E & Cinemática & El robot debe desplazarse por los pasillos de la planta a una velocidad nominal de 1 m/s. & Necesidad de cubrir el área de inspección en un tiempo razonable sin comprometer la estabilidad de los sensores  \citep{ProyectoEjecutivo2024}. & Prueba de cinemática midiendo el tiempo de recorrido en un circuito de longitud conocida. \\ \hline

4 & E & Fuerzas & El sistema de locomoción debe ser capaz de superar pendientes con una inclinación de hasta 16°. & Topografía irregular, zanjas erosivas y desniveles comunes en las plantas solares a gran escala \citep{Salinas2025}. & Ensayo de tracción y estabilidad en rampa de prueba con inclinación ajustable. \\ \hline

5 & E & \multirow{2.5}{*}{Energía} & El sistema de almacenamiento y suministro de energía debe proporcionar una autonomía de operación ininterrumpida de al menos 1 hora sin requerir recarga externa. & El robot debe completar ciclos de inspección completos antes de verse forzado a recargar en una estación base \citep{ProyectoEjecutivo2024}. & Ensayo de descarga de energía bajo consumo nominal de motores e instrumentación. \\ \hline

6 & E & Materia & La estructura del vehículo y los protectores de la electrónica deben cumplir con un grado de protección IP44 e IK08; y deben operar sin degradación en un rango de temperatura ambiente de 10°C a 45°C & Exposición severa a polvo del desierto, temperaturas altas y fluctuantes, lluvias eventuales y posibles impactos mecánicos durante el recorrido \citep{ProyectoEjecutivo2024}. & Revisión de la certificación de la estructura, prueba de hermeticidad, ensayo de operación a distintas temperaturas de los componentes críticos.\\ \hline

7 & E & Señales  & El sistema de adquisición debe muestrear las variables meteorológicas en un intervalo de 5 segundos y registrarlas con una frecuencia máxima de 5 minutos. Asismismo, se debe empaquetar las variables climáticas en una trama de datos estructurada con un tamaño máximo de carga útil de 50 bytes y una capacidad de recepción remota para interpretar comandos externos con una latencia de 2 segundos. & Recomendaciones para el monitoreo meteorológico de precisión, optimizaciones de tiempo en el aire para redes inalámbricas seguridad operativa para frenado de emergencia.  \citep{IEC61724-1_2021}. & Inspección del tamaño de los bytes enviados y análisis de las marcas de tiempo en los archivos de almacenamiento de datos. \\ \hline
8 & E & Control & El sistema de navegación debe detectar obstáculos imprevistos dentro del área de un semicírculo de 1 metro de radio, ubicado en cada dirección de movimiento del robot, y recalcular su trayectoria para evadirlos. & Presencia de rocas, vegetación crecida o personal de mantenimiento bloqueando temporalmente el pasillo \citep{Figgis2025}. & Prueba de campo colocando obstáculos ciegos en la ruta predefinida del robot. \\ \hline

9 & E & Comunicación & El módulo de telemetría debe transmitir los paquetes de datos a la estación base garantizando un alcance efectivo mínimo de 200 metros en línea de vista. & Las plantas solares a escala comercial abarcan grandes extensiones de terreno longitudinal \citep{Figgis2025}. & Ensayo de pérdida de paquetes (\textit{ping}) alejando el robot progresivamente de la estación base. \\ \hline

10 & D & Mantenimiento & El robot debe contar con una lógica interna de recordatorio de mantenimiento para el usuario, con el fin de mitigar la acumulación de suciedad en los sensores para mantener una incertidumbre menor al 2\%. & La suciedad acumulada degrada críticamente la exactitud de los instrumentos de medición de irradiancia \citep{IEC61724-1_2021}. & Medición comparativa de irradiancia antes y después de activar el mecanismo bajo suciedad simulada. \\ \hline

11 & E & Seguridad & El vehículo debe disponer de un sistema de parada de emergencia que interrumpa la tracción en un tiempo de respuesta menor a 0.1 segundos. & Prevención de accidentes industriales y protección frente a pérdida total de control en la navegación \citep{ProyectoEjecutivo2024}. & Prueba de interrupción forzada de marcha cronometrada en laboratorio. \\ \hline
