...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{ 
		\includegraphics[width=1.2\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_Blackbox_v7.png}
	} \par\medskip
...
El Dominio de Energía se encarga de la recepción, gestión y distribución del recurso eléctrico necesario para garantizar el funcionamiento de todos los subsistemas del robot, a través del siguiente flujo, ilustrado en la Figura \ref{fig:Avance3_DomEnergia}:
...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{
		\includegraphics[width=1.2\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioEnergia.png}
	} \par\medskip
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.8\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioSensores.png} \par\medskip
...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{ 
		\includegraphics[width=0.9\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioControl.png}
	} \par\medskip
...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{ 
		\includegraphics[width=0.8\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioComunicacion.png}
	} \par\medskip
...
El Dominio de Interfaz, mostrado en la Figura \ref{fig:Avance3_DomInterfaz}  desempeña un rol dual en la arquitectura del robot: por un lado, actúa como el puerto de conexión para la instrumentación climática periférica y, por otro, se encarga de exteriorizar los estados operativos y advertencias críticas hacia el personal en el parque fotovoltaico. Para su funcionamiento general, todos los componentes de este subsistema son alimentados directamente por el flujo de energía del Dominio de Interfaz. El dominio cuenta con los siguientes bloques de función:
...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{ 
		\includegraphics[width=1.0\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioInterfaz.png}
	} \par\medskip
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.99\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioActuadores.png} \par\medskip
...
El Dominio Mecánico, mostrado en la Figura \ref{fig:Avance3_DomMecanico}, conforma el soporte estructural del vehículo y materializa las interacciones dinámicas y físicas con el entorno del parque solar. Está compuesto de las siguientes funciones:
...
\begin{figure}[H]
	...
	\makebox[\textwidth][c]{ 
		\includegraphics[width=1.25\textwidth]{Recursos/Imagenes/ImagenesDominios/A3_DominioMecanico.png}
	} \par\medskip
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		Conector Plug Jack DC \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorPlugJackDC.jpg} & 
		Conector de alta corriente XT60 \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorAltaCorriente.jpg} & 
		Contactos magnéticos \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorContactoMagnetico.jpg} \\ \hline
		
		\textbf{2. Proteger sistema eléctrico} & 
		Fusible cerámico de cartucho \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/FusibleCeramico.jpg} & 
		Fusible electrónico eFuse \par\smallskip \includegraphics[width=0.9\linewidth]{Recursos/Imagenes/ImagenesMatriz/eFuse.jpg} & 
		Disyuntor termomagnético \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/DisyuntorTermomagnetico.jpg} \\ \hline
		
		\textbf{3. Gestionar energía eléctrica} & 
		Batería NiMH + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/NiMh.jpg} & 
		Batería LiIon + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/LiIon.jpg} & 
		Batería LiPO + Battery Management System \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/LiPo.jpg} \\ \hline
		
		\textbf{4. Activar energía eléctrica} & 
		Seccionador rotativo manual \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Rotativo.jpg} & 
		Relé de estado sólido \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ReleEstadoSolido.jpg} & 
		Contactor mecánico \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Contactor.jpg} \\ \hline
		
		\textbf{5. Regular energía de Interfaz} \vspace{0.2cm} & 
		\multirow{3}{=}{\centering Regulador de bomba de carga fija\par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/PumpChargeRegulador.jpg}} & 
		\multirow{3}{=}{\centering Regulador lineal LDO \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/ReguladorLDO.jpg}} & 
		\multirow{3}{=}{\centering Regulador Shunt \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/ShuntRegulator.jpg}} \\ \cline{1-1}
		...
		Convertidor Buck DC-DC \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConvertidorBuck.jpg} & 
		Regulador de bomba de carga \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/PumpChargeRegulador.jpg} & 
		Regulador lineal LDO \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ReguladorLDO.jpg} \\ \hline
		%
		\pagebreak
		
		% --- INICIO BLOQUE 5-8 ---
		\textbf{9. Energizar Interfaz} \vspace{0.6cm} & 
		\multirow{3}{=}{\centering Cable trenzado estándar \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/CableTrenzado.jpg}} & 
		\multirow{3}{=}{\centering Conectores circular roscado \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorRoscado.jpg}} & 
		\multirow{3}{=}{\centering Barras colectoras Busbars \par\vspace{0.2cm} \includegraphics[width=0.65\linewidth]{Recursos/Imagenes/ImagenesMatriz/Busbar.jpg}} \\ \cline{1-1}
		...
		Cable de Baja Tensión \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/CableBajaTension.png} & 
		Conector Circular Roscado \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorRoscado.jpg} & 
		Barras colectoras Busbars \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Busbar.jpg} \\ \hline
		%%
		\textbf{13. Regular energía eléctrica de sensores meteorológicos} & 
		Regulador de bomba de carga \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/PumpChargeRegulador.jpg} & 
		Regulador lineal LDO \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ReguladorLDO.jpg} & 
		Regulador Shunt \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ShuntRegulator.jpg} \\ \hline
		%%
		\textbf{14. Energizar  sensores meteorológicos} & 
		Cable trenzado estándar \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/CableTrenzado.jpg} & 
		Conector circular roscado \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorRoscado.jpg} & 
		Barras colectoras Busbars \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Busbar.jpg} \\ \hline
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		Termistor NTC \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/TermistorNTC.jpg} & 
		Termopar tipo K \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Termopar.jpg} & 
		Sensor RTD PT100 \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorRTD.jpg} \\ \hline
		
		\textbf{2. Sensar nivel de energía del gestionador} & 
		Detector de umbral de voltaje \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorNivelVoltaje.jpg}& 
		Sensor contador de Culombios \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorNivelCoulomb.jpg} & 
		Sensor de impedancia interna \par\smallskip \includegraphics[width=0.9\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorNivelImpedencia.png} \\ \hline
		
		\textbf{3. Sensar presencia de obstáculo} & 
		Sensor 3D de tiempo de vuelo \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorToF.jpg}& 
		Módulo CMOS \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/CMOSModule.jpg} & 
		Sensor LiDAR 3D \par\smallskip \includegraphics[width=0.9\linewidth]{Recursos/Imagenes/ImagenesMatriz/LIDAR3D.jpg} \\ \hline
		
		\textbf{4. Sensar velocidad de traslación} & 
		Encoder rotativo incremental\par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/EncoderRotativoIncremental.jpg} & 
		Unidad IMU de 9 ejes \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/IMU9Ejes.jpg} & 
		Radar de onda continua \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/RadarOndaContinua.jpg} \\ \hline
		
		\textbf{5. Sensar orientación plataforma} & 
		Sensor de distancia por tiempo de vuelo \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorDistanciaToF.jpg} & 
		Unidad IMU de 9 ejes \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/IMU9Ejes.jpg} & 
		Encoder rotativo absoluto \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/EncoderRotativoAbsoluto.jpg} \\ \hline
		
		\textbf{6. Sensar posición de plataforma} & 
		Sensor de fin de carrera \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/FinDeCarrera.jpg} & 
		Potenciómetro lineal \par\bigskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/PotenciometroLineal.jpg}& 
		Sensor de ultrasonido \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorUltrasonido.jpg} \\ \hline
		
		\textbf{7. Captar señal GPS} & 
		Antena de circuito flexible \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/AntenaFlexible.png} & 
		Antena de parche cerámico \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/AntenaGNSS.jpg} & 
		Antena GPS RTK \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/AntenaGPSRTK.jpg} \\ \hline
		
		\textbf{8. Sensar orientación del sistema} & 
		\par\smallskip Unidad IMU de 9 ejes \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/IMU9Ejes.jpg} & 
		\par\smallskip Unidad IMU de 9 ejes  \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/IMU9Ejes.jpg} & 
		Matriz de sensores de distancia por tiempo de vuelo \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SensorDistanciaToF.jpg} \\ \hline
...
\begin{itemize}
	...
	\item \textbf{Sensar nivel de energía del gestionador:} Se consideró el detector de umbral de voltaje, el cual generaría lecturas erróneas debido a las severas caídas de tensión que sufren las baterías al superar pendientes del 28\,\% \citep{Salinas2025}; el sensor de impedancia; y el contador de Culombios, principio tecnológico clave integrado en los avanzados Sistemas de Gestión de Baterías (BMS) de las estaciones meteorológicas \textit{IoT} evaluadas en el estado del arte para operar en terrenos remotos \citep{SK302020A3}.
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		\multirow{13}{=}{\centering Microcontrolador \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/Microcontrolador.jpg}} & 
		\multirow{13}{=}{\centering Placa SBC \par\vspace{0.2cm} \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SBC.jpg}} & 
		\multirow{13}{=}{\centering PLC \par\vspace{0.2cm} \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/PLC.jpg}} \\ \cline{1-1}
		...
		Microcontrolador \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Microcontrolador.jpg} & 
		Placa SBC \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SBC.jpg} & 
		Computadora Industrial \par\smallskip \includegraphics[width=0.9\linewidth]{Recursos/Imagenes/ImagenesMatriz/IPC.jpg} \\ \hline
		\textbf{15. Registrar datos meteorológicos} & 
		Memoria Flash \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/MemoriaFLASH.jpg} & 
		MicroSD SPI \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ModuloMicroSDSPI.jpg} & 
		EEPROM I2C \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/MemoriaEEPROMI2C.jpg} \\ \hline
		\textbf{16. Procesar rutas de inspección} & 
		Microcontrolador \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/Microcontrolador.jpg} & 
		Placa SBC \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/SBC.jpg} & 
		Coprocesador GPS \par\smallskip \includegraphics[width=0.9\linewidth]{Recursos/Imagenes/ImagenesMatriz/ModuloGPSDeadReckoning.jpg} \\ \hline
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
		...
		\textbf{1. Procesar datos meteorológicos} & 
		\multirow{8}{=}{\centering Look-up table \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/LookUpTables.png}} & 
		\multirow{8}{=}{\centering Algoritmo por ecuación \par\vspace{0.2cm} \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/AlgoritmoEcuacion.png}} & 
		\multirow{8}{=}{\centering Algoritmo de promedio \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/AlgoritmoPromedio.png}} \\ \cline{1-1}
		\textbf{2. Procesar temperatura del gestionador} & & & \\ \cline{1-1}
		\textbf{3. Procesar nivel energía del gestionador} & & & \\ \cline{1-1}
		\textbf{4. Procesar estado energía del gestionador} & & & \\ \cline{1-1}
		\textbf{5. Procesar velocidad de traslación} & & & \\ \cline{1-1}
		...
		\multirow{3}{=}{\centering Control SMC \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ControlSMC.png}} & 
		\multirow{3}{=}{\centering Control PID \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ControlPID.png}} & 
		\multirow{3}{=}{\centering Lógica Difusa \par\vspace{0.2cm} \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/LogicaDifusa.png}} \\ \cline{1-1}
		\textbf{10. Controlar movimiento de orientación de plataforma} & & & \\ \cline{1-1}
		\textbf{11. Controlar posicionamiento de plataforma} & & & \\ \hline
		% --- FILAS INDIVIDUALES ---
		\textbf{12. Procesar dirección de traslación} & 
		Controlador Stanley paralelo \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/StanleyParalelo.png} & 
		Algoritmo Pure Pursuit \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/PurePursuit.png} & 
		Algoritmo Vector Pursuit\par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/VectorPursuit.png} \\ \hline
		\textbf{13. Procesar señal de obstáculo} & 
		Comparación por umbrales y ventanas de tiempo \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/Thresholding.png} & 
		Flujo óptico \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/OpticalFlow.jpg} & 
		Agrupamiento y segmentación \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/AgrupamientoSegmentacion.png} \\ \hline
		\textbf{14. Registrar datos meteorológicos} & 
		Buffer de almacenamiento asíncrono \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/AsyncMemoria.jpg} & 
		Acceso directo a sistemas de archivos embebidos \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/FAT32.png} & 
		Motores de data bases \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/SQLite.png} \\ \hline
		\textbf{15. Procesar rutas de inspección} \vspace{1.5cm} & 
		\multirow{2}{=}{\centering A - Navigation por mapas de nodos \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/RoadmapNodes.jpg}} & 
		\multirow{2}{=}{\centering B - Navegación por histograma de campo vectorial\par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/VectorFieldNav.png}} & 
		\multirow{2}{=}{\centering C - Navegación por mapas de costo\par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/Costmap.png}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{2}{=}{ Trilaterización \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/AntenaGNSS.jpg}} & 
		\multirow{2}{=}{ Trilaterización con Dead Reckoning \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ModuloGPSDeadReckoning.jpg}} & 
		\multirow{2}{=}{ Medición de fase de onda \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ModuloFasePortadora.jpg}} \\ \cline{1-1}
		\textbf{2. Procesar señal de mando} \vspace{0.8cm} & & & \\ \hline
		% --- FIN BLOQUE 1-2 ---
		% --- INICIO BLOQUE 3-4 ---
		\textbf{3. Transmitir estado de telemetría} \vspace{0.8cm} & 
		\multirow{2}{=}{Protocolo MQTT +Wi-Fi\par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ProtocoloMQTT.png}} & 
		\multirow{2}{=}{Módulo LoRa \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/ModuloLoRa.jpg}} & 
		\multirow{2}{=}{Celular LTE-M \par\smallskip \includegraphics[width=0.7\linewidth]{Recursos/Imagenes/ImagenesMatriz/CelularLTEM.jpg}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{4}{=}{Conector circular roscado \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorRoscado.jpg}} & 
		\multirow{4}{=}{Borna con resorte interno \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/BornaResorte.jpg}} & 
		\multirow{4}{=}{Conector Deutsch \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ConectorDeutsch.jpg}} \\ \cline{1-1}
		...
		\multirow{2}{=}{Buzzer \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/Buzzer.jpg}} & 
		\multirow{2}{=}{Pantalla LCD \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/PantallaLCD.jpg}} & 
		\multirow{2}{=}{Sirena LED \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/SirenaLED.jpg}} \\ \cline{1-1}
		...
		\multirow{2}{=}{LEDs indicadores \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/LEDIndicador.jpeg}} & 
		\multirow{2}{=}{Pantalla LCD \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/PantallaLCD.jpg}} & 
		\multirow{2}{=}{Pantalla HMI \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/PantallaHMI.jpg}} \\ \cline{1-1}
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		& Motor de Cubo de Rueda \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/MotorCuboDeRueda.jpg} & Servomotor Brushless DC \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ServomotorBrushless.jpg} &  Motorreductor DC  \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/MotorreductorDC.png} \\ \hline
		\textbf{2. Accionar orientación de la plataforma} & 
		Microservo digital \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/Miniservo.jpg}& Servomotor Brushless DC \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ServomotorBrushless.jpg}& 	Motor paso a paso NEMA \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/MotorNEMA.jpg}\\ \hline
		\textbf{3. Accionar posición de la plataforma} &
		Actuador lineal \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ActuadorLineal.jpg} & Servomotor Brushless DC \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ServomotorBrushless.jpg}& Actuador lineal \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/ActuadorLineal.jpg}\\ \hline
...
\begin{center}
	...
	\begin{xltabular}{\textwidth}{|p{3.5cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		...
		\multirow{2}{=}{Piezas de MDF \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/PiezasMDF.jpg}} & 
		\multirow{2}{=}{Perfil V-Slot \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/Vslot.jpg}} & 
		\multirow{2}{=}{Chapas de Acero \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/ChapaAcero.jpg}} \\ \cline{1-1}
		\textbf{2. Soportar componentes} & & & \\ \hline
		\textbf{3. Proteger componentes} \vspace{1cm}& 
		\multirow{3}{=}{Carcasa impresa en 3D \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/Carcasa3D.jpg}} & 
		\multirow{3}{=}{Caja de chapa de aluminio \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/CajaChapaAluminio.jpg}} & 
		\multirow{3}{=}{Caja de acero inoxidable \par\smallskip \includegraphics[width=0.8\linewidth]{Recursos/Imagenes/ImagenesMatriz/CajaChapaAcero.jpg}} \\ \cline{1-1}
		\textbf{4. Alojar gestionador} & & & \\ \cline{1-1}
		\textbf{5. Alojar memoria externa} & & & \\ \hline
		\textbf{6. Generar movimiento de traslación} & 
		Ruedas onmidireccionales \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/RuedaOnmidireccional.jpg} & 
		Tracción diferencial (4 ruedas) \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/RuedasTraccionDiferencial.png} & 
		Ruedas con tracción de oruga \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/RuedasTraccionOruga.jpg} \\ \hline
		\textbf{7. Orientar plataforma} & 
		Eje acoplado a motor \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/MotorEje.jpg}& 
		Mecanismo tornillo sinfin-corona curva \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/TornilloSinFinCorona.jpg}& 
		Transmisión por correa dentada \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/TransmisionCorreaDentada.jpg}\\ \hline
		\textbf{8. Posicionar plataforma} & 
		Soporte vertical  \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/SoporteVertical.jpg}& 
		Plataforma elevadora de tijera \par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/TijeraElevacion.png}& 
		Elevacion por articulación telescópica\par\smallskip \includegraphics[width=\linewidth]{Recursos/Imagenes/ImagenesMatriz/PlataformaTelescopica.jpg}\\ \hline
	\end{xltabular}
\end{center}
