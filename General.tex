...
%	Resumen
%----------------------------------------------------------------------------------------
\input{TFC1/resumen} %Se agrega el resumen
...
\input{TFC1/conclusiones} %Se agregan las conclusiones
...
\thispagestyle{empty}
\includepdf[landscape=true, pages=-]{Recursos/Anexos/DiagramaGantt.pdf}
